...
/*
	int32 test
*/
type uint_TestPlace struct {
	Col1  uint `db:"col1" type:"int"`
	Col2  uint `db:"col2" type:"bigint"`
	Col3  uint `db:"col3" type:"smallint"`
	Col4  uint `db:"col4" type:"integer"`
	Col5  uint `db:"col5" type:"serial"`
	Col6  uint `db:"col6" type:"bigserial"`
...
var uint_mTestType *AllRows = &AllRows{
	SType: reflect.TypeOf(uint_TestPlace{}),
}

func _71_uint_func_test(t *testing.T, s *Searcher) {
	sql_create := " CREATE TABLE public.test " +
		"(col1 int, col2 bigint, col3 smallint, col4 integer, " +
		"col5 serial, col6 bigserial, col7 text, col8 varchar(50), col9 char(10), " +
		" col11 real, col12 double precision, col13 numeric, col14 decimal, col15 money, col16 boolean  " +
	...
	make_t_table(s, sql_create, sql_cols, sql_vals)
	p := []uint_TestPlace{}
	s.Get(uint_mTestType, &p, "SELECT * FROM public.test ORDER BY 1")
}
